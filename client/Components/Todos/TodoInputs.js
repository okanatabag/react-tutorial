...
export default function TodoInputs(props) {
    return(<div>
                <div className="inputs_container">
                    <input id={props.todoTextElement.element} name={props.todoTextElement.element} className="todo_inputs"  onChange={props.handleChange} onKeyPress={props.setTodoByEnter} type="text" value={props.todoTextElement.val}/>
